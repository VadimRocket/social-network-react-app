...
let initialState = {
    users:  [
        ...
        { id: 2, status: 'active', followed: false, location: {city: 'Berlin', country:'Germany'}, name:'Jack', photo: 'http://avotarov.net/picture/avatar-100/kartinki/905.jpg' },
        ...
        { id: 4, status: 'active', followed: false,  location: {city: 'Akaa', country:'Finland'},  name:'Alex', photo: 'http://avotarov.net/picture/avatar-100/kartinki/910.jpg' },
    ],
};
